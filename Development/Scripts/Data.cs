    ...
    namespace StartingItemsGUI {
        public class Data : MonoBehaviour {
            ...
            static void SaveConfig() {
                ...
                configString += "\n\n# The multiplier for how many EarntConsumable credits to award on Typhoon\n#\n# Setting type: Float\n# Default value: " + DataEarntConsumable.TyphoonMultiplierDefault.ToString() + "\n" + DataEarntConsumable.TyphoonMultiplierName[0] + variableCharUpdate + DataEarntConsumable.TyphoonMultiplier.ToString();
                ...
                configString += "\n\n# The multiplier for how many EarntPersistent credits to award on Typhoon\n#\n# Setting type: Float\n# Default value: " + DataEarntPersistent.TyphoonMultiplierDefault.ToString() + "\n" + DataEarntPersistent.TyphoonMultiplierName[0] + variableCharUpdate + DataEarntPersistent.TyphoonMultiplier.ToString();                
