...
namespace Phedg1Studios {
    namespace StartingItemsGUI {
        public class DataEarntPersistent : MonoBehaviour {
            ...
            static public float TyphoonMultiplierDefault = 6;
            ...
            static private float TyphoonObliterateStages = 0;
            ...
            static public List<string> TyphoonMultiplierName = new List<string>() { "TyphoonPurchasedPersistent" };
                    ...
                    if (!string.IsNullOrEmpty(userStagesString)) {
                        ...
                        if (splitString.Length == 9) {
                            ...
                            if (stagesParsed) {
                                ...
                                TyphoonWinStages = newStages[9];
                                TyphoonLossStages = newStages[10];
                                TyphoonObliterateStages = newStages[11];
                            }
                        }
                    }
                }
            ...
            static void CalculatePoints() {
                ...
                points += TyphoonWinStages * (TyphoonMultiplier * winMultiplier - defaultMultiplier);
                points += TyphoonLossStages * (TyphoonMultiplier * lossMutliplier - defaultMultiplier);
                points += TyphoonObliterateStages * (TyphoonMultiplier * obliterateMultiplier - defaultMultiplier);
